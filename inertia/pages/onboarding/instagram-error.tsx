    ...
    <>
      ...
      <div className="min-h-screen bg-bg flex flex-col">
        <div className="flex-1 px-5 pt-12 pb-32 max-w-lg mx-auto w-full">
          ...
          {/* Error message */}
          <Card variant="flat" className="mt-6 bg-red-500/10 border border-red-500/20">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-[14px] font-semibold text-red-400">Erreur de connexion</h3>
                <p className="text-[13px] text-red-300 mt-1 leading-relaxed">{errorMessage}</p>
              </div>
            </div>
          </Card>

          {/* Tips */}
          <Card variant="flat" className="mt-4 bg-white/5 border border-border">
