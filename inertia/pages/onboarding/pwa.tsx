...
export default function Pwa({ step, totalSteps }: Props) {
  ...
  const SafariShareIcon = () => (
    <svg className="w-4.5 h-4.5 inline-block align-middle text-blue-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="mt-6">
            ...
            <div className="flex justify-center mt-10">
              <div className="text-center">
                <div className="w-16 h-16 rounded-2xl shadow-card mx-auto flex items-center justify-center overflow-hidden">
                  <img src="/apple-touch-icon.png" alt="Le Phare" className="w-full h-full" />
                </div>
