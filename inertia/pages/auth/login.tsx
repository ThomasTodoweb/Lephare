      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          ...
          <div className="space-y-3 mb-6">
            <a
              href="/auth/google"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-neutral-200 rounded-full font-bold text-neutral-700 hover:bg-neutral-50 transition-colors"
            >
            ...
            <button
              disabled
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-neutral-300 text-neutral-500 rounded-full font-bold cursor-not-allowed"
            >
