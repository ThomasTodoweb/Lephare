...
export function PopoteMessage({
  ...
  return (
    ...
    >
      ...
      {/* Bulle de texte */}
      <div className="flex-1 bg-bg-card border-2 border-border rounded-2xl px-4 py-3 relative">
        {/* Flèche vers l'avatar */}
        <div className="absolute left-0 top-3 -translate-x-2 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-bg-card" />
        <div className="absolute left-0 top-3 -translate-x-[10px] w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-border" />
